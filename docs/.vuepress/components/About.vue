        ...
        <div class="profile">
            <div class="profile__content">
                <div class="profile__basic col-md-4">
                    ...
                    <div class="sns">
                        <div v-if="$page.frontmatter.github" class="sns__item">
                            <a :href="$page.frontmatter.github">
                                <v-icon name="ri-github-fill" scale="1.82" />
                            </a>
                        </div>
                        <div v-if="$page.frontmatter.telegram" class="sns__item">
                            <a :href="$page.frontmatter.telegram">
                                <v-icon name="co-telegram-plane" scale="1.82" />
                            </a>
                        </div>
                        <div v-if="$page.frontmatter.email" class="sns__item">
                            <a :href="$page.frontmatter.email">
                                <v-icon name="hi-mail" scale="1.82" />
                            </a>
                        </div>
                        <!-- <div
                            v-for="(user, platform) in $themeConfig.personalInfo
                                .sns"
                ...
                <div class="profile__info col-md-8">
                    ...
                    <div class="personal-info">
                        <div class="col-md-5 interests">
                            ...
                            <ul>
                                <li
                                    v-for="(item, index) in $page.frontmatter
                                        .interests"
                                    :key="`interests-${index}`"
                                >
